...
negative_df = df.copy()
negative_df = negative_df[negative_df["Biopac"].isin([11, 12, 13, 14])]
...
neutral_df = df.copy()
neutral_df = neutral_df[neutral_df["Biopac"].isin([31, 32, 33, 34])]
...
positive_df = df.copy()
positive_df = positive_df[positive_df["Biopac"].isin([51, 52, 53, 54])]
...
rest_df = df.copy()
rest_df = rest_df[rest_df["Biopac"].isin([2, 4])]
