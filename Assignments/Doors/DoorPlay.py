...
def run_task(window: visual.Window, params: dict, roundNum: int, coinsNumber: int, io):
    ...
    while len(scenariosList) != 0:
        ...
        win, total_time = DoorPlayInfra.start_door(window, params, image, scenario[0], scenario[1], distanceFromDoor, io)
        coinsNumber += win
